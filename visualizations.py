...
def barchart_restaurants(dict1,name):
    ...
    plt.bar(types,average,color=['black', 'red', 'green', 'orange', 'blue', 'pink','purple', 'cyan','yellow','grey'])
    plt.xlabel('Type Category',fontdict = font2)
    plt.ylabel('Average Ratings',fontdict = font2)
    plt.title('Average Rating per Restaurant Category',fontdict = font1)
